     ...
     public static string PassiveKey;
        ...
        public class Dash
        {
            ...
            public Dash(Spell arg)
            {
                ...
                {
                    DashSpell = arg;
                    DashMenu = ChampionMenu.Add(new Menu("QDash", "Dash Spell Setting", true));
                    DashMenu.Add(new MenuList("DashMode", "Dash Mode", new string[] { "Mouse", "Side", "Safe" }, 2));
                    DashMenu.Add(new MenuSlider("EnemyCheck", "Dash EndPosition Max EnemyHero Count", 3, 1, 5));
                    DashMenu.Add(new MenuSlider("CheckRange", "-> Check Range", 450, 100, 800));
                    DashMenu.Add(new MenuBool("WallCheck", "Dont Dash To Wall"));
                    DashMenu.Add(new MenuKeyBind("TurretCheck", "Dont Dash To Enemy Turrent", Keys.A, KeyBindType.Toggle, true)).AddPermashow();
                    DashMenu.Add(new MenuBool("AAcheck",  "Dash End Position Can Attack Any EnemyHero"));
                    DashMenu.Add(new MenuBool("notDashAARange", "Dont Dash into Melee Enemy Attack Range"));
        ...
        public class PlusRender
        {
            ...
            public static List<Color> GetFullColorList(int totalCount, bool redToPurple = true)
            {
                ...
                if (totalCount > 0)
                {
                    if (redToPurple)
                    {
                        colorList.AddRange(GetSingleColorList(System.Drawing.Color.Red, System.Drawing.Color.Yellow, totalCount / 10 + (totalCount % 11 > 0 ? 1 : 0)));
                        colorList.AddRange(GetSingleColorList(System.Drawing.Color.Yellow, System.Drawing.Color.Lime, totalCount / 10 + (totalCount % 11 > 1 ? 1 : 0)));
                        colorList.AddRange(GetSingleColorList(System.Drawing.Color.Lime, System.Drawing.Color.Cyan, totalCount / 10 + (totalCount % 11 > 2 ? 1 : 0)));
                        colorList.AddRange(GetSingleColorList(System.Drawing.Color.Cyan, System.Drawing.Color.Blue, totalCount / 10 + (totalCount % 11 > 3 ? 1 : 0)));
                        colorList.AddRange(GetSingleColorList(System.Drawing.Color.Blue, System.Drawing.Color.Magenta, totalCount / 10 + (totalCount % 11 > 4 ? 1 : 0)));
                        colorList.AddRange(GetSingleColorList(System.Drawing.Color.Magenta, System.Drawing.Color.Blue, totalCount / 10 + (totalCount % 11 > 5 ? 1 : 0)));
                        colorList.AddRange(GetSingleColorList(System.Drawing.Color.Blue, System.Drawing.Color.Cyan, totalCount / 10 + (totalCount % 11 > 6 ? 1 : 0)));
                        colorList.AddRange(GetSingleColorList(System.Drawing.Color.Cyan, System.Drawing.Color.Lime, totalCount / 10 + (totalCount % 11 > 7 ? 1 : 0)));
                        colorList.AddRange(GetSingleColorList(System.Drawing.Color.Lime, System.Drawing.Color.Yellow, totalCount / 10 + (totalCount % 11 > 8 ? 1 : 0)));
                        colorList.AddRange(GetSingleColorList(System.Drawing.Color.Yellow, System.Drawing.Color.Red, totalCount / 10 + (totalCount % 11 > 9 ? 1 : 0)));
                        colorList.AddRange(GetSingleColorList(System.Drawing.Color.Red, System.Drawing.Color.Red, totalCount / 10 + (totalCount % 11 > 10 ? 1 : 0)));
                    }
                    else
                    {
